...
public class kabab extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(kabab.this,MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(q.equals("Select")){
                    Toast.makeText(kabab.this, "Select Amount", Toast.LENGTH_SHORT).show();
                }
                else {
                    if (txt1.getText() == "Added") {
                        Toast.makeText(kabab.this, "Already Added", Toast.LENGTH_SHORT).show();
                    } else {
                        txt1.setText("Added");
