...
public class rice extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(rice.this,MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(q.equals("Select")){
                    Toast.makeText(rice.this, "Select Amount", Toast.LENGTH_SHORT).show();
                }
                else {
                    if (txt1.getText() == "Added") {
                        Toast.makeText(rice.this, "Already Added", Toast.LENGTH_SHORT).show();
                    } else {
                        txt1.setText("Added");
